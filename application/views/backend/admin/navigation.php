    ...
    <ul id="main-menu" class="">
        ...
        ?> ">
            <a href="#">
                ...
                <span> <?php echo ucwords(get_phrase('student')); ?></span>
            </a>
            <ul>
                <!-- STUDENT ADMISSION -->
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ucwords(get_phrase('class')); ?></span>
            </a>
            <ul>
        ...
        <li class="<?php if ($page_name == 'subject') echo 'opened active'; ?> ">
            <a href="#">
                ...
                <span><?php echo ucwords(get_phrase('subject')); ?></span>
            </a>
            <ul>
                <?php
                $classes = $this->db->get('class')->result_array();
        ...
        <li class="<?php if ($page_name == 'class_routine') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/class_routine">
                ...
                <span><?php echo ucwords(get_phrase('class_routine')); ?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'manage_attendance') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/manage_attendance/<?php echo date("d/m/Y"); ?>">
                ...
                <span><?php echo ucwords(get_phrase('daily_attendance')); ?></span>
            </a>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ucwords(get_phrase('exam')); ?></span>
            </a>
            <ul>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ucwords(get_phrase('accounting')); ?></span>
            </a>
            <ul>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ucwords(get_phrase('settings')); ?></span>
            </a>
            <ul>
